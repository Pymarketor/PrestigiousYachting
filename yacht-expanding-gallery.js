...
(() => {
  ...
  style.textContent = `
    ...
    .wrapper-main-gallery{height:clamp(28rem,48vw,42rem)!important;min-height:28rem!important;align-items:stretch!important}
    .wrapper-main-gallery>.video-container.yacht{flex:1 1 55%!important;min-width:0!important;height:100%!important}
    .wrapper-main-gallery>${COMPACT_ROOT}{box-sizing:border-box!important;display:block!important;flex:0 0 45%!important;width:45%!important;max-width:45%!important;min-width:45%!important;height:100%!important;min-height:0!important;padding:0 0 0 .625rem!important;overflow:visible!important}
    ${COMPACT_ROOT} .flex-v-gallery{display:grid!important;width:100%!important;height:100%!important;min-height:0!important;padding:0!important;grid-template-columns:repeat(2,minmax(0,1fr))!important;grid-template-rows:repeat(2,minmax(0,1fr))!important;gap:.625rem!important}
    ${COMPACT_ROOT} .flex-v-gallery>${CARD}{position:relative!important;width:100%!important;height:100%!important;min-width:0!important;min-height:0!important;overflow:hidden!important;border-radius:.675rem!important;background-color:#e8e8e8!important;background-position:center!important;background-repeat:no-repeat!important;background-size:cover!important}
